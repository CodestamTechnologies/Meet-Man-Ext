...
let lastSpeaker = '';
let startTime;
let extensionDiv, statusDiv, responseDiv, questionInput, askButton, clearButton, copyButton, buttonContainer, signInButton, uiContainer;
...
function createUI() {
    ...
    uiContainer.appendChild(questionInput);
    uiContainer.appendChild(askButton);
    uiContainer.appendChild(statusDiv);
    uiContainer.appendChild(responseDiv);
    uiContainer.appendChild(buttonContainer);

    extensionDiv.appendChild(signInButton);
    extensionDiv.appendChild(uiContainer);
